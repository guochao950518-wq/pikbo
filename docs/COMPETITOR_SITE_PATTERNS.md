...
1. **Community 项目感** — ✅ ProjectCard + Official remake  
2. **Viral preset 命名** — ✅ `viralNames.ts`  
3. **Generate 中心路径** — ✅ tiles → `/create?effect=`  
4. **账号/额度闭环**（产品）：否则定价页是假转化 — 仍 open  

### P1

5. Seedance **战役条** — ✅ SeedanceCampaign  
6. Apps/Models **一点进工具** — ✅ live 分区，soon 不可假点  
7. Pricing chrome 可发现 — ✅ 顶栏 / 侧栏 / 手机 Plans
