...
| H-WAVE-A | Core video parity: Home, Explore, Create, Effects, Project, Assets, Seller Pack | Grok | todo | agent/grok/higgsfield-wave-a | Boss reassigned while Claude is unavailable; implement `HIGGSFIELD_PUBLIC_PARITY.md` Wave A before suite expansion |
