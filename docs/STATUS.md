...
| T23 | Claude audit: homepage/pricing promise consistency sweep | GPT | done | agent/gpt/claude-copy-audit | cached/shared previews, concept recipes, and provider-gated paths labeled honestly |
