...
export const PRESETS: Preset[] = [
  ...
  },
  {
    ...
    emoji: "💥",
    name: "Box Burst",
    gradient: "linear-gradient(135deg,#ff7a18,#ff3d81)",
    category: "unboxing",
    audience: "seller",
    tagline: "Packaging parts burst apart, then snap back around the toy.",
    h1: "AI Box Burst Video Effect for Toy Launches",
    seoTitle: "Box Burst Toy Packaging Video Effect | Pikbo",
    seoDescription: "Animate owned toy packaging into a fast parts-burst reveal for launch reels and product ads.",
    intro: "Turn a clean packaging photo into a kinetic reveal where panels, inserts, and the figure separate in space before locking into a polished hero frame.",
    body: [
      "The effect is designed for launch hooks where the package is part of the product story.",
      "Upload a front-facing product photo with readable edges and keep brand artwork simple for the most stable result.",
    ],
    keywords: ["box burst video", "toy packaging animation", "product reveal effect"],
    faq: [{ q: "Does this preserve packaging text?", a: "Small text can drift in generative video, so review every output before using it in a paid ad." }],
    promptTemplate: "The collectible toy package separates into clean panels and inserts in a controlled cinematic burst, the figure holds its exact form at center, then every component snaps back together into a premium hero frame, crisp studio light, no added logos or text.",
    duration: 5,
    aspectRatio: "9:16",
  },
  {
    ...
    emoji: "🧸",
    name: "Shelf to Life",
    gradient: "linear-gradient(135deg,#80ff72,#7ee8fa)",
    category: "comealive",
    audience: "collector",
    tagline: "A still shelf wakes up one character at a time.",
    h1: "Make a Toy Shelf Come Alive with AI",
    seoTitle: "Shelf to Life AI Video Effect for Toy Collections | Pikbo",
    seoDescription: "Animate a photo of your own collectible shelf into a short, coordinated character moment.",
    intro: "Give a collection photo a clear story beat: the camera approaches, one figure reacts, and the rest of the shelf joins the moment without turning into visual noise.",
    body: [
      "This recipe prioritizes small, readable gestures over chaotic full-scene motion.",
      "It works best with a straight-on shelf image, even lighting, and space around each figure.",
    ],
    keywords: ["make toy shelf come alive", "collection animation", "toy shelf video"],
    faq: [{ q: "Will every figure move?", a: "The recipe limits motion to a few clear beats to protect character consistency across a crowded shelf." }],
    promptTemplate: "A display shelf of collectible toys subtly comes alive, slow camera push-in, the lead character turns and waves, nearby figures respond with restrained readable gestures, preserve every toy design and shelf layout, warm cinematic display lighting.",
    duration: 5,
    aspectRatio: "16:9",
  },
  {
    slug: "product-to-world",
    emoji: "🌎",
    name: "Product to World",
    gradient: "linear-gradient(135deg,#00c6ff,#7f00ff)",
    category: "scene",
    audience: "seller",
    tagline: "Expand the product backdrop into a branded miniature world.",
    h1: "AI Product-to-World Video for Designer Toys",
    seoTitle: "Product to World AI Video Generator for Toys | Pikbo",
    seoDescription: "Build a miniature campaign world around one owned designer-toy product image.",
    intro: "Start on the original product frame, then reveal a coherent miniature environment shaped by its colorway, material, and campaign mood.",
    body: [
      "The transition keeps the product as the anchor while expanding the set around it.",
      "Use it for launch teasers, campaign openers, and product-page hero clips.",
    ],
    keywords: ["product world video", "toy campaign video", "ai product environment"],
    faq: [{ q: "Can I control the world style?", a: "Yes. Add a short art-direction note in Studio while keeping the product reference unchanged." }],
    promptTemplate: "Begin on the exact collectible toy product frame, then the background expands into a detailed miniature world inspired by the toy color palette and material, smooth cinematic pull-back, product stays recognizable and central, no new logos or text.",
    duration: 5,
    aspectRatio: "16:9",
  },
  {
    ...
    category: "comealive",
    audience: "seller",
    tagline: "Your character steps into light and lands on its hero mark.",
    h1: "AI Hero Entrance Video for Action Figures",
    seoTitle: "Hero Entrance AI Video Effect for Figures | Pikbo",
    seoDescription: "Create a controlled cinematic entrance from one photo of a toy you own.",
    intro: "Turn a static figure into a clean character introduction with a silhouette, one decisive movement, and a product-safe final pose.",
    body: [
      "The recipe keeps the motion short so sculpt, face, and colorway remain the focus.",
      "It is suited to character launches, roster reveals, and campaign title cards.",
    ],
    keywords: ["hero entrance video", "action figure animation", "toy character intro"],
    faq: [{ q: "Does it invent a new costume?", a: "The prompt explicitly asks the model to preserve the uploaded sculpt, outfit, and colorway." }],
    promptTemplate: "The exact collectible character steps from silhouette into a narrow beam of light, one confident forward movement, subtle low camera push, then holds a strong hero pose, preserve sculpt outfit and colorway, cinematic haze, no transformation.",
    duration: 5,
    aspectRatio: "9:16",
  },
  {
    ...
    category: "scene",
    audience: "collector",
    tagline: "A tiny portal opens and places the figure in a new scene.",
    h1: "Portal Arrival AI Video Effect for Toys",
    seoTitle: "Portal Arrival Toy Video Effect | Pikbo",
    seoDescription: "Send your own figure through a cinematic miniature portal without changing its design.",
    intro: "Open on a familiar shelf or tabletop, reveal a compact portal, and transition the same figure into a stylized miniature environment.",
    body: [
      "The transition is staged around the toy instead of replacing it with a generic character.",
      "Use it for episodic collector stories or a reveal that needs more narrative than a spin.",
    ],
    keywords: ["portal video effect", "toy teleport animation", "figure scene transition"],
    faq: [{ q: "What source image works best?", a: "Use a full-body view with clean space beside the figure so the portal can form without covering it." }],
    promptTemplate: "A small luminous portal opens beside the exact collectible figure, energy curls around the base, the camera follows as the unchanged toy arrives in a coherent miniature world, stable sculpt and colors, cinematic light, no extra characters.",
    duration: 5,
    aspectRatio: "9:16",
  },
  {
    ...
    category: "unboxing",
    audience: "seller",
    tagline: "A hand-held collector view that reveals scale and detail.",
    h1: "AI Collector POV Product Video for Toys",
    seoTitle: "Collector POV Toy Product Video Generator | Pikbo",
    seoDescription: "Turn an owned toy photo into a short collector-perspective product clip for social commerce.",
    intro: "Reframe a catalog image as an intimate collector-perspective reveal with controlled hand-held movement and macro detail beats.",
    body: [
      "POV framing makes scale and surface detail easier to understand in a feed.",
      "Keep claims honest: the generated clip is a creative preview, not evidence of real handling or condition.",
    ],
    keywords: ["collector pov video", "toy product pov", "figure detail video"],
    faq: [{ q: "Can I use it for resale condition proof?", a: "No. Use real photos or footage for condition evidence; this recipe is for creative marketing only." }],
    promptTemplate: "Collector point-of-view product reveal of the exact toy, subtle handheld camera movement, controlled macro push toward sculpt and material details, realistic scale cues, clean desk lighting, preserve all product features, no fake labels.",
    duration: 5,
    aspectRatio: "9:16",
  },
  {
    ...
    category: "showcase",
    audience: "seller",
    tagline: "A fast inventory-drop hook built around the actual SKU.",
    h1: "AI Restock Alert Video Maker for Toy Brands",
    seoTitle: "Restock Alert Video Maker for Collectible Brands | Pikbo",
    seoDescription: "Create a fast restock social hook from one authorized product photo, ready for vertical channels.",
    intro: "Make the product—not generic typography—the first visual beat, then add a fast camera snap and a clean hold where your team can place accurate stock copy in editing.",
    body: [
      "The generated plate intentionally avoids invented prices, dates, or availability claims.",
      "Export the clean motion plate and add verified restock details in your normal editor.",
    ],
    keywords: ["restock alert video", "toy restock reel", "inventory announcement video"],
    faq: [{ q: "Does Pikbo add the sale date?", a: "No. The recipe leaves a clean copy area so your team can add verified details after generation." }],
    promptTemplate: "Fast restock campaign motion plate featuring the exact collectible SKU, energetic snap zoom, inventory cases appear behind the hero product, bold clean lighting, finish with stable negative space for verified copy, no generated text prices or dates.",
    duration: 5,
    aspectRatio: "9:16",
  },
  {
    slug: "colorway-switch",
    emoji: "🎨",
    name: "Colorway Switch",
    gradient: "linear-gradient(135deg,#00f2fe,#f857a6)",
    category: "showcase",
    audience: "seller",
    tagline: "Transition between authorized colorway references on one hero mark.",
    h1: "AI Toy Colorway Switch Video Effect",
    seoTitle: "Toy Colorway Switch AI Video Effect | Pikbo",
    seoDescription: "Create a launch-ready colorway transition using product references your brand owns.",
    intro: "Show multiple approved editions as a rhythmic campaign sequence while keeping the sculpt, camera, and lighting consistent.",
    body: [
      "This recipe needs a reference image for every colorway shown; it must not invent products you do not sell.",
      "A fixed camera and simple background make the material and paint changes easier to read.",
    ],
    keywords: ["colorway switch video", "toy variant animation", "product color transition"],
    faq: [{ q: "Can it invent new colorways?", a: "The PIKBO recipe is intended for uploaded, authorized variants only so the output matches real SKUs." }],
    promptTemplate: "Locked camera product shot of the exact collectible sculpt transitioning only between the supplied authorized colorway references, smooth material-aware wipes, identical pose proportions and lighting, premium launch film, no invented variants or text.",
    duration: 5,
    aspectRatio: "1:1",
  },
];
